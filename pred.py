...
class Detector(object):
    ...
    def detect(self, data_subset, prob_threshold=0.7, area_threshold=100, vis=False):
        ...
        for i in tqdm(range(0, self.img_len)):
            img = self.load_img_from_file(self.img_list[i])  # targets
...
if __name__ == '__main__':
    ...
    data_seq_nums = pd.read_csv(os.path.join(args.mot_path, 'MOT17','seq_nums.csv'))
    seq_nums = list(data_seq_nums.video.unique())
